...
\begin{tikzpicture}[remember picture, overlay] 
    \node[anchor = north east] at ($(current page.north east)+(-2cm,-1.2cm)$) {\includegraphics[height=3cm]{CV-W.jpg}};
  \end{tikzpicture}%
...
\centerline{\normalsize{\faGithubSquare\ \href{https://github.com/shenluyao}{https://github.com/shenluyao} \quad \faRssSquare\ \href{https://shenluyao.github.io/}{https://shenluyao.github.io}}} 
    
\section{\makebox[\widthof{\faGraduationCap}][c]{\color{CVBlue}\faGraduationCap}\ 教育背景}    
\textbf{浙江大学} \hfill 2025.9 -- 至今\\[0.5em] % 标题和正文间加一点距离
工业设计\quad 大一 
\begin{itemize}[nosep]
    \item 相关课程成绩：《线性代数甲》94/4.8、《C程序设计基础及实验》92/4.8
\end{itemize}
\textbf{浙江省春晖中学} \hfill 2022.9 -- 2025.6\\[0.5em] % 标题和正文间加一点距离
...
\begin{itemize}[nosep]
    \item \textbf{编程语言：} \textbf{Go}, Python, C++，C语言
    \item \textbf{开发工具：} Git, VS Code, Pygame, PyCharm
    \item \textbf{操作系统：} Windows
\end{itemize}
\section{\makebox[\widthof{\faGraduationCap}][c]{\color{CVBlue}\faList}\ 英语水平}
\begin{itemize}
    \item 大学英语Ⅲ \hfill 90/4.5
    \item CET-4 \hfill 
    \item 英语高考 \hfill 140
    
\end{itemize}
    
\section{\makebox[\widthof{\faInfo}][c]{\color{CVBlue}\faInfo}\ 学生工作与社团经历}
\begin{itemize}[parsep=0.5ex]
    \item \textbf{云峰分团委：} 实践部干事--参与组织云峰暑期结项答辩&&云峰十佳答辩
    \item \textbf{机器人协会：} 组织部干事--参与组织湖州开放日活动；参加内训、小车巡线比赛
\end{itemize}
\end{document}
